...
public class Calculator {
  ...
  public interface Iface {
    ...
    public long multiply(int num1, int num2, int num3) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void multiply(int num1, int num2, int num3, org.apache.thrift.async.AsyncMethodCallback<java.lang.Long> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public long multiply(int num1, int num2, int num3) throws org.apache.thrift.TException
    {
      send_multiply(num1, num2, num3);
      return recv_multiply();
    }

    public void send_multiply(int num1, int num2, int num3) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void multiply(int num1, int num2, int num3, org.apache.thrift.async.AsyncMethodCallback<java.lang.Long> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      multiply_call method_call = new multiply_call(num1, num2, num3, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class multiply_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Long> {
      ...
      private int num2;
      private int num3;
      public multiply_call(int num1, int num2, int num3, org.apache.thrift.async.AsyncMethodCallback<java.lang.Long> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.num1 = num1;
        this.num2 = num2;
        this.num3 = num3;
...
//      @Override
      ...
      public multiply_result getResult(I iface, multiply_args args) throws org.apache.thrift.TException {
        multiply_result result = new multiply_result();
        result.success = iface.multiply(args.num1, args.num2, args.num3);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class multiply<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, multiply_args, java.lang.Long> {
      ...
      public void start(I iface, multiply_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Long> resultHandler) throws org.apache.thrift.TException {
        iface.multiply(args.num1, args.num2, args.num3,resultHandler);
      }
    }
  ...
  public static class multiply_args implements org.apache.thrift.TBase<multiply_args, multiply_args._Fields>, java.io.Serializable, Cloneable, Comparable<multiply_args>   {
    ...
    public multiply_args setNum3(int num3) {
      this.num3 = num3;
      setNum3IsSet(true);
      return this;
    }
